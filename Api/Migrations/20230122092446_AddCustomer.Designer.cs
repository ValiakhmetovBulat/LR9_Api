...
namespace Api.Migrations
{
    ...
    [Migration("20230122092446_AddCustomer")]
            ...
            modelBuilder.Entity("Api.Models.Sklad.Product_stock", b =>
                {
                    ...
                    b.HasIndex("productID")
                        .HasDatabaseName("ix_product_stock_product_id");
            ...
            modelBuilder.Entity("Api.Models.Sklad_rashod", b =>
                {
                    ...
                    b.HasIndex("customerID")
                        .HasDatabaseName("ix_sklad_rashods_customer_id");
            ...
            modelBuilder.Entity("Api.Models.Sklad.Product_stock", b =>
                {
                    b.HasOne("Api.Models.Product", "Tovar")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_stock_products_product_id");
            ...
            modelBuilder.Entity("Api.Models.Sklad_rashod", b =>
                {
                    b.HasOne("Api.Models.User", "Customer")
                        ...
                        .HasConstraintName("fk_sklad_rashods_users_customer_id");
